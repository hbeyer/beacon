...
class beacon_repository {
    ...
    public $beacon_sources = array(
        ...
        'baltbl' => array('label' => 'Baltisches biografisches Lexikon', 'location' => 'https://bbld.de/beacon.gnd.txt', 'target' => 'https://bbld.de/GND{ID}', 'type' => 'default'),
        ...
        'badb' => array('label' => 'Badische Biographie', 'location' => 'http://www.statistik-bw.de/LABI/Badische-Biographien.txt', 'target' => '', 'type' => 'specified'),
        ...
        'lltirol' => array('label' => 'Lexikon Literatur in Tirol und Südtirol', 'location' => 'http://www.andreas-praefcke.de/temp/BEACON-PND-Literatur-Tirol.txt', 'target' => '', 'type' => 'specified'),
        ...
        'requiem' => array('label' => 'Requiem - Die römischen Papst- und Kardinalsgrabmäler der Frühen Neuzeit', 'location' => 'http://www.andreas-praefcke.de/temp/BEACON-GND-Requiem-Pro.txt', 'target' => '', 'type' => 'specified'),
        ...
        'tc2a' => array('label' => 'Tagebücher Christians II. von Anhalt-Bernburg (1599–1656)', 'location' => 'http://diglib.hab.de/edoc/ed000228/materialien/TBChristianII_beacon.txt', 'target' => 'http://diglib.hab.de/edoc/ed000228/register/listPerson.html#{ID}', 'type' => 'specified'),
        ...
        'tripota' => array('label' => 'Trierer Porträtdatenbank', 'location' => 'http://www.tripota.uni-trier.de/beacon_tripota.txt', 'target' => 'http://www.tripota.uni-trier.de/beacon.php?ID={ID}', 'type' => 'default'),        
        ...
        'pmhk' => array('label' => 'Personen und Körperschaften in den Beständen der Museumslandschaft Hessen-Kassel', 'location' => 'https://datenbank.museum-kassel.de/gnd-p.txt', 'target' => 'https://datenbank.museum-kassel.de/?gnd-p={ID}', 'type' => 'default'),
        'bkm' => array('label' => 'Bildindex der Kunst und Architektur von Foto Marburg', 'location' => 'https://www.bildindex.de/gnd_beacon.txt', 'target' => 'https://www.bildindex.de/gnd-beacon/{ID}', 'type' => 'default'),        
        ...
        'bmlo' => array('label' => 'Bayerisches Musiker-Lexikon Online (BMLO)', 'location' => 'http://www.bmlo.lmu.de/beacon/', 'target' => 'http://bmlo.de/Q/GND={ID}', 'type' => 'default'),
