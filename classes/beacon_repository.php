...
class beacon_repository {
    ...
    public $beacon_sources = array(
        ...
        'tc2a' => array('label' => 'Tagebücher Christians II. von Anhalt-Bernburg (1599–1656)', 'location' => 'http://www.tagebuch-christian-ii-anhalt.de/files/beacon.txt', 'target' => 'http://diglib.hab.de/edoc/ed000228/register/listPerson.html#{ID}', 'type' => 'specified'),
