...
class beacon_repository {
    ...
    public $beacon_sources = array(
        ...
        'kgv' => array('label' => 'Kieler Gelehrtenverzeichnis', 'location' => 'https://cau.gelehrtenverzeichnis.de/webdav/beacon.txt', 'target' => '', 'type' => 'specified'),
        ...
        'ldf' => array('label' => 'Lebenswelten, Erfahrungsräume und politische Horizonte der ostpreußischen Adelsfamilie Lehndorff vom 18. bis in das 20. Jahrhundert', 'location' => 'https://lebenswelten-digital.bbaw.de/register/personen/beacon.xql?type=all&authority=gnd', 'target' => 'https://lebenswelten-digital.bbaw.de/register/personen/detail.xql?normid=http://d-nb.info/gnd/{ID}', 'type' => 'default'),
        ...
        'duennh' => array('label' => 'Dünnhaupt-Autoren im VD17', 'location' => 'http://www.vd17.de/files/duennhaupt-beacon.txt', 'target' => 'https://kxp.k10plus.de/DB=1.28/CMD?ACT=SRCHA&TRM=nid+{ID}', 'type' => 'default'),
