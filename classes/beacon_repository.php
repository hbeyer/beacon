...
class beacon_repository {
    ...
    public $beacon_sources = array(
        ...
        'cors' => array('label' => 'correspSearch – Verzeichnisse von Briefeditionen', 'location' => 'http://correspsearch.net/api/v1/gnd-beacon.xql?correspondent=all', 'target' => 'http://correspsearch.bbaw.de/search.xql?correspondent=http://d-nb.info/gnd/{ID}&l=de', 'type' => 'default'),
