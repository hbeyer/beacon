...
class beacon_repository {
    ...
    public $beacon_sources = array(
        ...
        'gqdm' => array('label' => 'Geschichtsquellen des deutschen Mittelalters', 'location' => 'http://www.historische-kommission-muenchen-editionen.de/beacond/repfont-autoren.php?beacon', 'target' => 'http://www.historische-kommission-muenchen-editionen.de/beacond/repfont-autoren.php?pnd={ID}'),
        ...
        'gpa' => array('label' => 'Graphikportal – Akteure', 'location' => 'https://www.graphikportal.org/gnd_beacon_event.txt', 'target' => 'https://www.graphikportal.org/gnd-beacon/{ID}'),
        'gpd' => array('label' => 'Graphikportal – Dargestellte', 'location' => 'https://www.graphikportal.org/gnd_beacon_subject.txt', 'target' => 'https://www.graphikportal.org/gnd-beacon/{ID}'),
	...
	'aqhab' => array('label' => 'Alchemische Bestände der HAB', 'location' => 'http://alchemie.hab.de/beacon.txt', 'target' => 'http://alchemie.hab.de/personen?gnd={ID}')
    );
